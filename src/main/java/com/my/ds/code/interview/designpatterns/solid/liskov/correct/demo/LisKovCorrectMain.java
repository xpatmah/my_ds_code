package com.my.ds.code.interview.designpatterns.solid.liskov.correct.demo;


import com.my.ds.code.interview.designpatterns.solid.liskov.correct.impl.LiskovUserController;

import java.io.IOException;

public class LisKovCorrectMain {
	...
	public static void main(String[] args) throws IOException {
		LiskovUserController controller = new LiskovUserController();
